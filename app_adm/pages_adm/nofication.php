            ...
            <div class="col-lg-7">
               <div class="mb-3">     
                  <div class="input-group mb-2">
                     <span class="input-group-text bg-transparent border rounded-0" id="basic-addon1"><i class="fa-solid fa-magnifying-glass gray2"></i></span>
               ...
               <div class="d-flex justify-content-between mt-4">
                  <div class="row">
                     ...
                     <div class="col-lg-10">
                        <div class="row">
                           <div class="col">
                              <h5 class="fs-custom3 mn-blue fw-semibold">Guber <span class="fw-normal">escreveu uma nota</span></h5>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col">
                              <h5 class="fs-custom4 mn-blue fw-light">Re: <span class="fw-normal border-bottom">Juliana Simões</span></h5>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-6">
                           <div class="mt-4">
                              ...
                              <h1 class="fs-custom2 fw-bold text-uppercase">R$250.000 <span class="fw-normal fs-custom3 gray2">Á venda</span></h1>
                              <h1 class="fs-custom2 fw-bold text-uppercase">R$1.200 <span class="fw-normal fs-custom3 gray2">Para alugar</span></h1>
                              <p class="fs-custom3 gray2">Apartamento em Água Branca, São Paulo</p>
                              <span class="gray2 me-1 fs-custom3"><i class="fa-solid fa-kaaba fs-custom4 me-1"></i>72m²</span>
                              <span class="gray2 me-1 fs-custom3"><i class="fa-solid fa-bed fs-custom4 me-1"></i>2</span>
                              <span class="gray2 me-1 fs-custom3"><i class="fa-solid fa-car fs-custom4 me-1"></i>1</span>
                              <span class="gray2 me-1 fs-custom3"><i class="fa-solid fa-shower fs-custom4 me-1"></i>1</span>
                           </div>
                        </div>
                     </div>
                  </div>
