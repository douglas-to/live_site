...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: '../php_adm/listar_evento.php',
        ...
        eventClick: function (info) {
            ...
            document.getElementById("visualizar_users").innerText = info.event.extendedProps.users;
            ...
            document.getElementById("edit_users").value = info.event.extendedProps.users;
    ...
    if (formCadEvento) {
        ...
        formCadEvento.addEventListener("submit", async (e) => {
            ...
            const dados = await fetch("../php_adm/cadastrar_evento.php", {
                method: "POST",
                body: dadosForm
            });
    ...
    if (formEditEvento) {
        ...
        formEditEvento.addEventListener("submit", async (e) => {
            ...
            const dados = await fetch("../php_adm/editar_evento.php", {
                method: "POST",
                body: dadosForm
            });
            ...
            if (!resposta['status']) {
                ...
                if (eventoExiste) {
                    ...
                    eventoExiste.setExtendedProp('users', resposta['users']);
    ...
    if (btnApagarEvento) {
        ...
        btnApagarEvento.addEventListener("click", async () => {
            ...
            if (confirmacao) {
                ...
                const dados = await fetch("../php_adm/apagar_evento.php?id=" + idEvento);
